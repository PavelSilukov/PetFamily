...
namespace petFamily.Infrastructure.Migrations
{
    ...
    [Migration("20250723214728_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("petFamily.Domain.PetManagement.Entities.Volunteer", b =>
                {
                    b.OwnsOne("petFamily.Domain.PetManagement.ValueObjects.RequisiteList", "RequisiteList", b1 =>
                        {
                            ...
                            b1.OwnsMany("petFamily.Domain.PetManagement.ValueObjects.Requisite", "Requisites", b2 =>
                                {
                                    ...
                                    b2.Property<string>("PaymentMethod")
                                        .IsRequired()
                                        .HasColumnType("text");
                    ...
                    b.OwnsOne("petFamily.Domain.PetManagement.ValueObjects.SocialNetList", "SocialNetList", b1 =>
                        {
                            b1.Property<Guid>("VolunteerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.ToJson("social_net_list");

                            b1.WithOwner()
                                .HasForeignKey("VolunteerId")
                                .HasConstraintName("fk_volunteers_volunteers_id");

                            b1.OwnsMany("petFamily.Domain.PetManagement.ValueObjects.SocialNet", "SocialNetworks", b2 =>
                                {
                                    b2.Property<Guid>("SocialNetListVolunteerId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.HasKey("SocialNetListVolunteerId", "Id")
                                        .HasName("pk_volunteers");

                                    b2.ToTable("Volunteers");

                                    b2.WithOwner()
                                        .HasForeignKey("SocialNetListVolunteerId")
                                        .HasConstraintName("fk_volunteers_volunteers_social_net_list_volunteer_id");
                                });
